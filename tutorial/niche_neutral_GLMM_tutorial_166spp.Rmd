...
```{r test 4.1}
#Calculating R2
r2.det.rt <- r2.full(nineu.det.rt, null.model = neu.det)$R2
r2.sto <- r2.neutral(neu.sto, null.model = neu.sto)$R2
...
r2.det.wt <- r2.full2(envneu.det, null.model = neu.det)$R2
