...
```{r r-squared table}
# Functions to calculate R-squared for each random effect, each function fot each possible best model
# adapted from Nakagawa
...
#Calculating R2
r2.det.rt
r2.det.wt <- r2.full2(envneu.det)$R2
